...
const FloadCreating: React.FC<{ handleCloseCreate: () => void }> = ({ handleCloseCreate }) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await axios.post('/user/create', newUser); // Endpoint para crear usuarios
      handleCloseCreate();
    } catch (error) {
