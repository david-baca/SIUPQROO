        ...
        contenido={
          <>
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="">
                <tr>
                  <th className="border border-black border-5 px-6 py-3 text-center font-medium text-gray-500 uppercase tracking-wider">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {periods.map((row, index) => (
                  <tr key={index}>
                    <td className="border border-black border-5 px-6 py-4 text-center">
                      {row.Periodo}
                    </td>
                    <td className="border border-black border-5 px-6 py-4 text-center">
                      {row.fecha_fin.substring(0, 4)}
                    </td>
                  </tr>
                ))}
              </tbody>
            ...
            <div className="flex justify-end my-6 mx-5">
              <button
                className="font-bold mr-2 bg-[#ec6b0c] text-white py-2 px-4 rounded-xl"
          ...
          <>
            <div className="flex flex-col items-center">
              <h1 className="text-center font-bold text-xl">
                ¡Ups! Parece que no hay datos cargados, no puedes eliminar.{' '}
              </h1>
